 ...
 */
function sirvl_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'sirvl_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.sirvl-front-page) .entry-title,
...
.colors-custom .sirvl-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.sirvl-front-page .panel-content .recent-posts article,
...
.colors-custom.sirvl-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'sirvl_custom_colors_css', $css, $hue, $saturation );
}
